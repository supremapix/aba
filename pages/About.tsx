  ...
  return (
    <div className="pt-20">
      ...
      <section className="py-16 relative overflow-hidden" aria-labelledby="pilares-title">
        <div className="absolute top-0 left-0 w-full h-full bg-aba-blue/5 -z-10 transform -skew-y-3" aria-hidden="true"></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <ScrollAnimation delay={0}>
              <article className="bg-white p-8 rounded-xl shadow-lg border-t-4 border-aba-blue text-center group hover:transform hover:-translate-y-2 transition-all h-full">
            ...
            <ScrollAnimation delay={150}>
              <article className="bg-white p-8 rounded-xl shadow-lg border-t-4 border-aba-orange text-center group hover:transform hover:-translate-y-2 transition-all h-full">
            ...
            <ScrollAnimation delay={300}>
              <article className="bg-white p-8 rounded-xl shadow-lg border-t-4 border-aba-green text-center group hover:transform hover:-translate-y-2 transition-all h-full">
      ...
      {/* History */}
      <section className="py-20 bg-white" aria-labelledby="trajetoria-title">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row gap-16 items-center">
            <div className="md:w-1/2 order-2 md:order-1">
              <ScrollAnimation>
                <div id="trajetoria-title">
            ...
            <div className="md:w-1/2 order-1 md:order-2">
              <ScrollAnimation delay={200}>
                <div className="grid grid-cols-2 gap-4 relative">
                  <div className="absolute inset-0 bg-aba-orange/10 rounded-full blur-3xl -z-10" aria-hidden="true"></div>
                  <img 
                ...
                <p className="text-center text-sm text-gray-500 mt-4 italic" aria-hidden="true">Acolhimento e preparação para a vida autônoma.</p>
              </ScrollAnimation>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <ScrollAnimation delay={0}>
              <div className="p-6 border border-white/10 rounded-lg bg-white/5 backdrop-blur-sm">
                <Users className="h-10 w-10 text-aba-orange mx-auto mb-4" aria-hidden="true" />
            ...
            <ScrollAnimation delay={100}>
              <div className="p-6 border border-white/10 rounded-lg bg-white/5 backdrop-blur-sm">
                <Award className="h-10 w-10 text-aba-green mx-auto mb-4" aria-hidden="true" />
            ...
            <ScrollAnimation delay={200}>
              <div className="p-6 border border-white/10 rounded-lg bg-white/5 backdrop-blur-sm">
                <Users className="h-10 w-10 text-aba-blue mx-auto mb-4" aria-hidden="true" />
            ...
            <ScrollAnimation delay={300}>
              <div className="p-6 border border-white/10 rounded-lg bg-white/5 backdrop-blur-sm">
                <Heart className="h-10 w-10 text-red-500 mx-auto mb-4" aria-hidden="true" />
      ...
      {/* Team */}
      <section className="py-20" aria-labelledby="equipe-title">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div id="equipe-title">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {TEAM.map((member, idx) => (
              <ScrollAnimation key={idx} delay={idx * 150}>
                <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow text-center group border border-gray-100 h-full">
                  <div className="relative w-40 h-40 mx-auto mb-6 rounded-full overflow-hidden border-4 border-gray-100 group-hover:border-aba-blue transition-colors">
                    <img src={member.image} alt={`Foto de ${member.name}`} className="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-500" loading="lazy" />
                  </div>
